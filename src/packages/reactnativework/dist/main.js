...
var register = function register(core, args, options, metadata) {
  ...
  proc.createWindow({
    ...
    return proc.destroy();
  }).render(); // Creates a new WebSocket connection (see server.js)
...
module.exports = JSON.parse("{\"type\":\"application\",\"name\":\"reactnativework\",\"category\":null,\"server\":\"server.js\",\"icon\":\"icon.png\",\"title\":{\"en_EN\":\"reactnativework\"},\"description\":{\"en_EN\":\"reactnativework\"},\"files\":[\"main.js\",\"main.css\"]}");
